...
/**
 * Using nurbs to generate surface vertices
 *
 * 	wrote to help with mesh issues and subdiv resorting
 */

THREE.NURBSSurfaceGeometry.prototype.build = function()
{
  // rebuild vertices **author not sure why
  if (this.vertices.length > 0)
    this.vertices.splice(0, this.vertices.length);

  // Loop through all u,v
  for (var i = 0; i < this.numPointsU; i++)
  {
    ...
    for (var j = 0; j <= this.numPointsV; j++)
    {
      ...
      // Sorting vertices in pairs rather than in single rows
